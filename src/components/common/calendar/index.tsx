...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  const fromDate = selectedRange?.fromDate
    ? moment(selectedRange?.fromDate, format).startOf('day').format(format)
    : ''
  const toDate = selectedRange?.toDate
    ? moment(selectedRange?.toDate, format).endOf('day').format(format)
    : ''
