...
import IconHorizontalDots from '@/utils/icons/IconHorizontalDots'
import { Select } from '../select'
import IconArrowLeft from '@/utils/icons/IconArrowLeft'
...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className='flex items-center justify-start py-2 text-sm md:flex-row'>
      ...
      {showQuickJumper && (
        <div className='mx-1 flex items-center whitespace-nowrap font-medium text-text-primary'>
          Đến
          <input
